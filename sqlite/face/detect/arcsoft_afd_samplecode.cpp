...
// #define INPUT_IMAGE_PATH    "/home/lxg/codedata/57.yuv"
// #define INPUT_IMAGE_PATH_JPG    "/home/lxg/codedata/57.jpg"

#define INPUT_IMAGE_PATH    "/home/lxg/codedata/yuv_bgr_0.yuv"
// #define INPUT_IMAGE_PATH    "/home/lxg/codedata/yuv_0.yuv"
#define INPUT_IMAGE_PATH_JPG    "/home/lxg/codedata/yuv_0.jpg"


// #define INPUT_IMAGE_WIDTH   (690)
// #define INPUT_IMAGE_HEIGHT  (474)
#define INPUT_IMAGE_WIDTH   (848)
...
int main(int argc, char* argv[]) {
    ...
    for (int i = 0; i < faceResult->nFace; i++) {
        printf("face %d:(%d,%d,%d,%d)\t angle:%d\n", i, 
               ...
               faceResult->lfaceOrient[i]);

    }

    cv::Mat im = cv::imread(INPUT_IMAGE_PATH_JPG);
    if(im.empty())
    {
        printf("img is empty\n");
    }
    for(int i = 0; i < faceResult->nFace; ++i)
    {
        cv::Rect rect(faceResult->rcFace[i].left, faceResult->rcFace[i].top, 
                        faceResult->rcFace[i].right-faceResult->rcFace[i].left, faceResult->rcFace[i].bottom-faceResult->rcFace[i].top);
