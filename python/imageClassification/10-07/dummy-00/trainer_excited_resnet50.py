...
def run_training():
    ...
    out_dir  = '/home/ck/project/results/ex-resnet50-00b' # s_xx1'
    initial_checkpoint = \
        '/home/ck/project/results/ex-resnet50-00a/checkpoint/00124000_model.pth'
        #  None

    pretrained_file = '/home/ck/project/data/pretrain/SE-ResNet-50.convert.pth'
    ...
    if initial_checkpoint is not None:
        ...
        start_iter  = 62000 #checkpoint['iter' ]
        start_epoch = 2 #checkpoint['epoch']
