...
image_root = "/home/lxg/codedata/headXml/data/all/" #图片目录

train_label_root = "" #训练集label文件夹
val_label_root = "" #验证集label文件夹
label_root = "/home/lxg/codedata/headXml/label/all/" #标签目录
...
train_Dataset = headDataset(split = train_images,transforms = [lambda x,y: randomHorizontalFlip2(x,y)], isTrain = True)
train_Dataloader = DataLoader(train_Dataset,batch_size=batch_size,shuffle=True,num_workers=4)

val_Dataset = headDataset(split = val_images, transforms= None, isTrain = False)
