...
int main(int argc, char **argv)
{
    ...
    String modelFile = "/home/lxg/codedata/head/model-best.net";
    String imageFile = "/home/lxg/codedata/default.jpg";
    if (!parser.check())
    {
        parser.printErrors();
        return 0;
    ...
    String classNamesFile = "/home/lxg/codedata/head/categories.txt";
    String resultFile = parser.get<String>("result");
