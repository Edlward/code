...
{
    return (CvBlobTrackerAuto*)new CvBlobTrackerAuto2(param);
}

/* Constructor of auto blob tracker: */
CvBlobTrackerAuto2::CvBlobTrackerAuto2(CvBlobTrackerAutoParam1* param):m_BlobList(sizeof(CvBlobTrackAuto))
{
...
} /* CvBlobTrackerAuto2::CvBlobTrackerAuto2 */
...
void CvBlobTrackerAuto2::Process(IplImage* pImg, IplImage* pMask)
{
    int         CurBlobNum = 0;
    IplImage*   pFG = pMask;
